...
#include "routes.h"
#include "ui_routesscreen.h"

Routes::Routes(QWidget *parent) : QWidget(parent), ui(new Ui::RoutesScreen)
{
    ui->setupUi(this);
...
TaskItem::TaskItem(QWidget *parent) : QPushButton(parent)
{
    ...
    fileDate->setAlignment(Qt::AlignLeft);
    fileType->setAlignment(Qt::AlignLeft);
