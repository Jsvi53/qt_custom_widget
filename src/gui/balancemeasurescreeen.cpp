...
BalanceMeasureScreen::BalanceMeasureScreen(QWidget *parent) : QWidget(parent), ui(new Ui::BalanceMeasureScreenUI)
{
    ui->setupUi(this);
    QGraphicsDropShadowEffect *navibarShadow = new QGraphicsDropShadowEffect(this);
    navibarShadow->setOffset(0, 5);
    navibarShadow->setColor(QColor(43, 43, 43));
    navibarShadow->setBlurRadius(20);
    ...
    buttomContainerShadow->setOffset(5, 5);
    buttomContainerShadow->setColor(QColor(43, 43, 43));
    buttomContainerShadow->setBlurRadius(8);
    ...
    connect(ui->naviBackBtn, &QPushButton::clicked, this, &BalanceMeasureScreen::backButtonClicked);
}
